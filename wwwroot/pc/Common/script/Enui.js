...
$(document).ready(function () {
    ...
    $("#gnbUi > ul > li > a").each(function (index) {
        $(this).click(function () {
            var offImgNameUrl = "/En/images/common/leftmenu0" + (oldIdx + 1);
            $("#gnbUi > ul > li > a > img").eq(oldIdx).attr("src", offImgNameUrl + "_off.gif");
            var onImgNameUrl = "/En/images/common/leftmenu0" + (index + 1);
    ...
    $("#snbUi > ul > li > a").each(function (index) {
        $(this).click(function () {
            var offImgNameUrl = "/En/images/common/leftmenu02_0" + (oldIdx + 1);
            $("#snbUi > ul > li > a > img").eq(oldIdx).attr("src", offImgNameUrl + "_off.gif");
            var onImgNameUrl = "/En/images/common/leftmenu02_0" + (index + 1);
            $(this).find("img").attr("src", onImgNameUrl + "_on.gif");
            $("#snbUi > ul > li > .subgnb").hide();
            $(this).siblings(".subgnb").fadeIn("slow");
            oldIdx = index;
            return false;
        });
    ...
    $('.showtmenu').click(function () {
        ...
        if (navigator.userAgent.match(/Mobile|iPhone|iPad|BlackBerry|Android|Windows CE|Windows Phone|Opera Mini|POLARIS/) != null) {
            ...
            $('#total_menu').animate({ height: "600px" }, 500);
        }
    ...
    $('.bizopen').click(function () {
        ...
        if (navigator.userAgent.match(/Mobile|iPhone|iPad|BlackBerry|Android|Windows CE|Windows Phone|Opera Mini|POLARIS/) != null) {
            ...
            //$('.bizView').slideDown();
            $('div.biz_top').animate({ top: "-47px" }, 500);
        }
    });
});
