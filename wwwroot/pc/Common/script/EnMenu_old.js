function GetLnbMenu(elementID, page, url) {
    ...
    if (navigator.userAgent.match(/Mobile|iPhone|iPad|BlackBerry|Android|Windows CE|Windows Phone|Opera Mini|POLARIS/) != null) {
        ...
        root = getXmlDocument("/Common/Xml/MobileEnMenu.xml");
        nodes = root.getElementsByTagName("node");

        lnbMenu = "<h1><a href='/En/'><img src='/En/Images/common/logo.gif' alt='GS 글로벌' /></a></h1>";

        if (page != "main")
            lnbMenu += "<div class='gnb' id=\"snbUi\">";
        else
        ...
        for (var i = 0; i < nodes.length; i++) {
            ...
            if (page != "main" && typeof (img) != "object") {
                img = img.replace("/leftmenu", "/leftmenu02_");
            ...
            var subline = nodes[i].getAttribute("subline");
            ...
            if (depth < 2) {
                ...
                if (page != "main" && line == 2)
                    lnbMenu += "<li class='line2'><a href=\"#\"><img src='" + img + "' alt='회사소개' /></a>";
                else
                    lnbMenu += "<li><a href=\"#\"><img src='" + img + "' alt='회사소개' /></a>";
                
                lnbMenu += "<div class=\"subgnb\" style=\"display:none;\">";
                lnbMenu += "<ul>";
                lnbMenu += "<p><a href=\"#\" class='close_btn'><img src='/Kr/images/common/main/btn_gnb_close.gif' alt='닫기'></a></p>";
            }
            else if (depth == 2) {
                var alt = "";
                ...
                if (page == "main" && subline == 2)
                    lnbMenu += "<li class='line2'><a href='" + link + "' target='" + target + "'><img src='" + img + "' alt='" + alt + "' /></a></li>";
                else
        ...
        root = getXmlDocument("/Common/Xml/EnMenu.xml");
        nodes = root.getElementsByTagName("node");

        var swf = "/Common/Swf/mainNavi_en.swf"
        var width = 341;
        var height = 560;
        var num1 = -1;
        var num2 = 0;
        ...
        lnbMenu = "<object classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000' width='" + width + "' height='" + height + "' id='mainNavi_en' align='middle'>";
        ...
        if (page == "main")
            lnbMenu += "<param name='flashVars' value='xmlPath=/Common/Xml/EnMenu.xml' />";
        else
            lnbMenu += "<param name='flashVars' value='xmlPath=/Common/Xml/EnMenu.xml&m=" + num1 + "&s=" + num2 + "' />";
...
function GetTopNavi(url) {
    ...
    var root = getXmlDocument("/Common/Xml/EnMenu.xml");
